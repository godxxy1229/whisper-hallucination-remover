...
# 제거할 특정 단어/구문 리스트
STOPWORDS = [
    "Thank you", "ご視聴ありがとうございました", "자막 제공", "Продолжение следует",
    "Vielen Dank", "Abertura", "お疲れ様でした", "お待ちしております", "Gracias",
    "고춧가루", "고추장", "한글자막", "はい", "ㅎ", "핳", "광고를 포함하고 있습니다",
    "おやすみなさい", "Oh,", "good.", "한효정", "Dzień dobry", "中文字幕志愿者 李宗盛",
    "시청자 여러분"
]
